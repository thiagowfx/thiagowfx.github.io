...
date: 2026-05-20T14:20:44+02:00
tags:
  - ai
  - bestof
  - dev
...
I asked Claude Opus 4.7 to
[generate](https://github.com/thiagowfx/.dotfiles/commit/fb23b4e653df1468d988ee02468fb5cd1fe769ee)
a [global `CLAUDE.md`](https://code.claude.com/docs/en/settings) for my tone & style based on historical usage for 12+
months. The result[^1] was added to my
[`thiagowfx/.dotfiles`](https://github.com/thiagowfx/.dotfiles/blob/fb23b4e653df1468d988ee02468fb5cd1fe769ee/claude/.claude/CLAUDE.md)
repo, cross-posted here for ease of reference and future preservation.

I expect this file to evolve over time. Updates won't be republished here; the
dotfiles repo is the source of truth.

[^1]: I performed a few manual tweaks. The end result was quite decent (to my
    taste).
